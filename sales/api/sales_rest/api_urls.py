...
from .views import api_sales_person, api_customer, api_sale_record_list, api_automobile_vo, api_customer_delete, api_sales_person_detail, api_sale_record_detail
